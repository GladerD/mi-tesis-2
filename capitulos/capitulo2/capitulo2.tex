...
\section{Metodología propuesta}
  ...
  \begin{figure}[H]
     \centering
     \input{diagramas/diagrama_flujo_metodologia.tex}
...
\begin{figure}[H]
    \centering
   \includegraphics[width=\textwidth]{figuras/Capitulo2/Test.pdf}
...
\begin{figure}[H]
    \centering
   \includegraphics[width=\textwidth]{figuras/Capitulo2/Distribucion_eigenvalues.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figuras/Capitulo2/PlanoZ_k_4.pdf}
        \includegraphics[width=\textwidth]{figuras/Capitulo2/PlanoZ_k_8.pdf}
    \includegraphics[width=\textwidth]{figuras/Capitulo2/PlanoZ_k_16.pdf}
...
\subsection{Robustez frente al Ruido de Medición}
 
El modelo de señal \eqref{eq:signal_model} incorpora explícitamente un
término de ruido de medición $w_i[n]$ cuyo efecto sobre la exactitud de
$\hat{f}_k$, $\hat{\zeta}_k$ y $\hat{a}_{i,k}$ se cuantifica a
continuación, evaluando el algoritmo completo (Multi-TK + selección de
orden del modelo/truncamiento de la SVD + estimación de los parametros modales) 
sobre el banco  de señales sinteticas variando la relación señal-ruido (SNR).


\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figuras/Capitulo2/DR_03_espectros_por_k.pdf}
    \caption{Truncamiento de la svd mediante los metodos propuestos.}
    \label{fig:trunc_svd_SNR}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figuras/Capitulo2/CRM_04_errores_por_K.pdf}
    \caption{Errores por cada parametro estimado.}
    \label{fig:Zplane_k_4}
\end{figure}


\subsection{Maximo de Modos Cercanos Resolubles (Límite de Resolución)}

La capacidad de multi-TK para distinguir dos modos de frecuencia cercananas 
estan acotadas por la duracion de la ventana de datos anlizada, independientemente 
del algoritmo de estimacion, se determina una diferencia en frecuencia minima $\Delta f$
para determinar si los modos cercanos son resolubles, es decir, si el algoritmo puede
estimarlos, se determina $\Delta f$ en funcion del amortiguamiento, los nivels de SNR y el
orden de prediccion $L$:
...
\subsection{Efecto en el numero de canales}
En la seccion \cite{subsec:Sis_Mul}



\subsection{Sensibilidad al Orden del Predictor \texorpdfstring{$L$}{L} }




\subsection{De Paramétrico a no Paramétrico: comparación de los criterios de truncamiento de la SVD}
