...
\begin{frame}
\frametitle{Patrones Dinámicos}
\framesubtitle{Separación de Grupos Coherentes por Corte Espectral de Grafos}
...
% -----------------------------------------------------------
\begin{frame}
\frametitle{Refinamiento por Proyección Variable}
\framesubtitle{Función de Costo y Proyección}
...
\begin{frame}
\frametitle{Refinamiento por Proyección Variable}
\framesubtitle{Inicialización y Separación de Modos Dominantes}
...
\begin{frame}
\frametitle{Refinamiento por Proyección Variable}
\framesubtitle{Restricciones y Algoritmo de Optimización}
...
\begin{frame} 
    \frametitle{Posible estructura del Capítulo 3}
\framesubtitle{Título Capítulo 3: Casos de Estudio\\
...
\begin{frame}{Objetivo del descarte de modos espurios}
\begin{itemize}
...
\begin{frame}{Criterio 1: Amplitud del residuo}
\begin{itemize}
...
\begin{frame}{Criterio 2: Energía del modo}
\begin{itemize}
...
\begin{frame}{Comparación de criterios}
\begin{center}
...
\begin{frame}{Selección de modos significativos}
\begin{enumerate}
...
\begin{frame}{Reconstrucción de la señal aproximada}
...
\begin{frame}{Integridad de pares complejos conjugados}
\begin{itemize}
...
\begin{frame}{Condición de protección}
...
\begin{frame}{Pasos del algoritmo de descarte}
\begin{enumerate}
